...
class MADDPGTorchModel(TorchModelV2, nn.Module):
    ...
    def __init__(
        ...
        actor_hiddens: List[int] = [64, 64],
        actor_hidden_activation: str = "relu",
        critic_hiddens: List[int] = [64, 64],
    ...
    def get_policy_output(self, model_out: TensorType) -> TensorType:
        ...
        """
        self.dist = self.policy_model(model_out)
        sampler = torch.distributions.RelaxedOneHotCategorical(temperature=1.0, logits=self.dist)
