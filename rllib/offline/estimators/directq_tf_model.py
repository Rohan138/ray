...
class DirectQTFModel(TFModelV2):
    """Extension of the standard TFModelV2 for SAC.

    To customize, do one of the following:
    - sub-class DirectQTFModel and override one or more of its methods.
    ...
    - Use SAC's `Q_model->custom_model` and `policy_model->custom_model` keys
      ...
      created within this DirectQTFModel (see `build_policy_model` and
      `build_q_model`.
    ...
    def __init__(
        ...
        """Initialize a DirectQTFModel instance.
        ...
        """
        super(DirectQTFModel, self).__init__(
    ...
    def build_policy_model(self, obs_space, num_outputs, policy_model_config, name):
        ...
        Override this method in a sub-class of DirectQTFModel to implement your
